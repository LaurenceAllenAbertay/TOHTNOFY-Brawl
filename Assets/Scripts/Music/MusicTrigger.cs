...
public class MusicTrigger
{
    ...
    [Header("Unit Type Trigger")]
    public string unitTypeName; // "PlayerUnit", "EnemyUnit", or specific unit names

    [Header("Combat State Trigger")]
    ...
    public TurnCountMode turnCountMode = TurnCountMode.CyclicTurns;
    public int turnNumber;
    public bool everyNthTurn = false; // If true, triggers every N turns

    [Header("Health Threshold Trigger")]
    [Range(0f, 1f)] public float healthPercentage = 0.3f;
